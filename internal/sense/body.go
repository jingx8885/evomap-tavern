...
var Organs = []Organ{
	...
	{Path: "internal/eye", Role: "eyes", Feel: "three separate looks: camera pixels, a screenshot of your own face, and the desktop (window titles, plus one picture when they ask what is visible)"},
