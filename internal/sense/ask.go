...
const (
	...
	AskShot      = "shot"      // screenshot of her own face
...
var (
	...
	shotRe   = regexp.MustCompile(`(?i)(看自己的样子|看看自己的样子|看你自己的样子|看自己样子|自己的样子|你的样子|你长什么样|你现在什么样|你现在什么样子|看看你自己|看你自己|你穿什么|what do you look like|your own appearance|look at yourself)`)
...
func ParseAsk(text string) Ask {
	...
	if shotRe.MatchString(t) {
		return Ask{Kind: AskShot}
	}
